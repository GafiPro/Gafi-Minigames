...
/** Shared, safe word data for word-based mini-games. */
public final class WordBank {
    private static final Logger LOGGER = LoggerFactory.getLogger("GafiMinigames/WordBank");
    ...
    private static List<String> load(){
        try(var stream=WordBank.class.getResourceAsStream(RESOURCE)){
            ...
            LOGGER.warn("Using the emergency word bank because {} could not be loaded.",RESOURCE,e);
            return List.of("MINECRAFT","REDSTONE","DIAMOND","CREEPER","VILLAGER","PORTAL","NETHER","ENDER","ELYTRA","PIGLIN","WARDEN","WITHER","SHIELD","TRIDENT","OBSIDIAN","EMERALD","AMETHYST","BAMBOO","CAMPFIRE","COMPASS","FURNACE","LANTERN","POTION","SPAWNER","VILLAGE","JUNGLE","OCEAN","TEMPLE","DUNGEON","DRAGON","GOLEM","ZOMBIE");
        }
    }
